...
export default function UpcomingSessionCard({
  ...
  return (
    <motion.div
      ...
      className="bg-slate-900/40 backdrop-blur-xl border border-white/5 p-6 rounded-3xl relative overflow-hidden group min-h-[260px] flex flex-col justify-between"
    >
      {/* Background Pattern */}
